import getCommandsModule from './modules/commands/getCommandsModule';
import { id } from './id';
import getLabInfoRoute from './labInfoRoute';
import getSopClassHandlerModule from './modules/sopClassHandler/getSopClassHandlerModule';
import getViewportModule from './modules/viewport/getViewportModule';
import getHangingProtocolModule from './modules/hangingProtocol/getHangingProtocolModule';
...
export default {
  ...
  getCustomizationModule: ({ servicesManager, commandsManager, extensionManager }) => {
    return [
      {
        name: 'default',
        value: {
